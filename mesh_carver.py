...
def draw_callback_px(self, context):
	...
	if(region.width >= 850):
		if(self.AskHelp == False):
			...
			if(self.ObjectMode or self.ProfileMode):
				if(self.ProfileMode):				 
					DrawLeftText("["+ context.scene.Key_Brush +"]", xHelp, yHelp + Help_Interval * 2, Help_FontSize, UIColor, self)
					DrawLeftText(": Object Mode", 150 + t_panel_width, yHelp + Help_Interval * 2, Help_FontSize, None, self)
				else:
					DrawLeftText("["+ context.scene.Key_Brush +"]", xHelp, yHelp + Help_Interval * 2, Help_FontSize, UIColor, self)
			...
			if((self.ObjectMode == False) and (self.ProfileMode == False)):
				if(self.CreateMode == False):
					DrawLeftText("["+ context.scene.Key_Create +"]", xHelp, yHelp + Help_Interval, Help_FontSize, UIColor, self)
				...
				if(self.CutMode == CIRCLE):
					DrawLeftText("MouseMove", xHelp, yHelp, Help_FontSize, UIColor, self)
					DrawLeftText("[Alt]", xHelp, yHelp - Help_Interval, Help_FontSize, UIColor, self)
					DrawLeftText("["+ context.scene.Key_Subrem +"] ["+ context.scene.Key_Subadd +"]", xHelp, yHelp - Help_Interval * 2, Help_FontSize, UIColor, self)
				...
				if(self.CutMode == LINE):
					...
					if(self.CreateMode):
						DrawLeftText("["+ context.scene.Key_Subadd +"]", xHelp, yHelp - Help_Interval * 4, Help_FontSize, UIColor, self)
				...
				DrawLeftText("["+ context.scene.Key_Scale +"]", xHelp, yHelp - Help_Interval * 2, Help_FontSize, UIColor, self)
				...
				if(self.ProfileMode):
					DrawLeftText("["+ context.scene.Key_Subadd +"]["+ context.scene.Key_Subrem +"]", xHelp, yHelp - Help_Interval * 5, Help_FontSize, UIColor, self)
					DrawLeftText(": Previous or Next Profile", 150 + t_panel_width, yHelp - Help_Interval * 5, Help_FontSize, None, self)
				DrawLeftText("[ARROWS]", xHelp, yHelp - Help_Interval * 6, Help_FontSize, UIColor, self)
				DrawLeftText(": Create / Delete rows or columns", 150 + t_panel_width, yHelp - Help_Interval * 6, Help_FontSize, None, self)
				DrawLeftText("["+ context.scene.Key_Gapy +"]["+ context.scene.Key_Gapx +"]", xHelp, yHelp - Help_Interval * 7, Help_FontSize, UIColor, self)
				DrawLeftText(": Gap between rows or columns", 150 + t_panel_width, yHelp - Help_Interval * 7, Help_FontSize, None, self)
...
def update_grid(self, context):
	...
	if self.nbcol < 1: self.nbcol = 1
	if self.nbrow < 1: self.nbrow = 1
	if self.gapx < 0 : self.gapx = 0
	if self.gapy < 0 : self.gapy = 0
...
#--Compute the corners so the new object will be always at the center
	...
	#---Add random rotation
		if(self.RandomRotation) and not (self.GridScaleX or self.GridScaleY):
			...
			for v in obverts: v.co = v.co * rotmat
	...
	def invoke(self, context, event):
		if context.area.type == 'VIEW_3D':
			...
			#---Copy the brush object 
				ob = bpy.data.objects.new("CarverBrushCopy", bpy.context.object.data.copy())
