...
bl_info = {
  ...
  "author": "Dr. Clemens Barth (barth@root-1.de)",
  "version": (1,1),
  "blender": (2,6),
  "api": 31236,
...
def Draw_scene(FLAG_group_atoms,group_atoms_dn,mesh_yn,Ball_azimuth,Ball_zenith,Ball_radius_factor,Ball_distance_factor,offset_x,offset_y,offset_z,Stick_yn,Stick_sectors,Stick_diameter, put_to_center, camera_yn, lamp_yn, Pdb_file, Data_file):
   ...
   # Arrays for all atoms in the data file
   Data_Number        = []
   Data_Atomname      = []
   Data_Shortname     = []
   Data_Color         = []
   ...
   # Arrays for atoms in the PDB file
   atom_object    = []
   atom_element   = []
   atom_name      = []
   atom_charge    = []
   ...
   if put_to_center == True:
      ...
      # All coordinates are summed up so far
      ...
      # After, the center of gravity is substracted
      for i in list(range(Number_of_total_atoms)):
