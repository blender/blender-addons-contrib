...
class CreaShapes(bpy.types.Operator):
    ...
    activeshape = bpy.props.BoolProperty(
        name="Only Active Shape",
        default=False)
    layoutcompat = bpy.props.BoolProperty(
        name="Layout Compatible", default=True)
...
class CreaGrupos(bpy.types.Operator):
    ...
    FACTORVG = bpy.props.FloatProperty(
        name="Factor",
        default=1,
        min=0,
        max=1000)
    ADDVG = bpy.props.FloatProperty(
        name="Addition",
        default=.5,
        min=0,
        max=1000)
