...
def generate_shelves(self,context):
    ...
    for i in range(0,self.shelves_num):
        myData = create_unit(self.stype,1,"Shelves" + str(i + 1)  
                           ...
                           , self.shelves[i].sNum, self.crt_mat
...
#------------------------------------------------------------------------------
def create_unit(stype,num,objName,thickness,sthickness,sX,sY,sZ,pX,pY,pZ,left,right,shelves,mat,zPos,top,bottom):
